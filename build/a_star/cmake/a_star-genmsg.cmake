...
message(STATUS "a_star: 1 messages, 0 services")

set(MSG_I_FLAGS "-Ia_star:/home/dennis/ROS/ROS_CAR/src/a_star/msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/dennis/ROS/ROS_CAR/src/a_star/msg/isReached.msg" NAME_WE)
add_custom_target(_a_star_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "a_star" "/home/dennis/ROS/ROS_CAR/src/a_star/msg/isReached.msg" ""
)
...
_generate_msg_cpp(a_star
  "/home/dennis/ROS/ROS_CAR/src/a_star/msg/isReached.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/a_star)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/a_star\")")
  # install generated code
  install(
